...
from app.environment import ConnectFourEnv # Ensure environment is compatible with SAC agent input format
...
if __name__ == '__main__':
    ...
    # Load SAC AI agents
    ai_agent_player1 = SACAgent(env, num_workers=4)
    ...
    ai_agent_player2 = SACAgent(env, num_workers=4)
