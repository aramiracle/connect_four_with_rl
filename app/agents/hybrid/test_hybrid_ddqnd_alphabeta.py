...
if __name__ == '__main__':
    ...
    # Test scenarios
    hybrid_vs_alphabeta_results = test_hybrid_vs_alphabeta(env, hybrid_agent_player1, alphabeta_agent_player2, num_games=100) # Test Hybrid vs AlphaBeta
    alphabeta_vs_hybrid_results = test_alphabeta_vs_hybrid(env, alphabeta_agent_player1, hybrid_agent_player2, num_games=100) # Test AlphaBeta vs Hybrid
