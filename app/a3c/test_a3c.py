...
def simulate_game(env, player1, player2):
    ...
    while not done:
        if env.current_player == 1:
            ...
            if isinstance(player2, A3CAgent):  # Check if player2 is an instance of A3CAgent
...
if __name__ == '__main__':
    ...
    # Load AI agents
    ai_agent_player1 = A3CAgent(env, num_workers=4)  # Use A3CAgent class directly
    ...
    ai_agent_player2 = A3CAgent(env, num_workers=4)  # Use A3CAgent class directly
