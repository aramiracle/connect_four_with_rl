...
def test_ai_vs_random_c51(env, c51_agent, num_games=1000):
    ...
    for _ in tqdm(range(num_games), desc='C51 vs Random Bot'):
    ...
    return c51_wins, random_bot_wins, draws
...
def test_random_bot_vs_ai_c51(env, c51_agent, num_games=1000):
    ...
    for _ in tqdm(range(num_games), desc='Random Bot vs C51'):
    ...
    return random_bot_wins, c51_wins, draws
...
def test_c51_vs_c51(env, c51_agent1, c51_agent2, num_games=1000):
    ...
    for _ in tqdm(range(num_games), desc='C51 vs C51'):
    ...
    return c51_1_wins, c51_2_wins, draws
...
if __name__ == '__main__':
    ...
    c51_vs_c51_results = test_c51_vs_c51(env, c51_agent_player1, c51_agent_player2, num_games=1000)

    # Print results
    print(f"C51 vs Random Bot Results: C51 Wins - {c51_vs_random_results[0]}, Random Bot Wins - {c51_vs_random_results[1]}, Draws - {c51_vs_random_results[2]}")
    print(f"Random Bot vs C51 Results: Random Bot Wins - {random_vs_c51_results[0]}, C51 Wins - {random_vs_c51_results[1]}, Draws - {random_vs_c51_results[2]}")
    print(f"C51 vs C51 Results: Player 1 Wins - {c51_vs_c51_results[0]}, Player 2 Wins - {c51_vs_c51_results[1]}, Draws - {c51_vs_c51_results[2]}")
