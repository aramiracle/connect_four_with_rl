...
if __name__ == '__main__':
    ...
    checkpoint_player1 = torch.load('saved_agents/dqn_agents_after_vs_agent_train.pth')
    ...
    checkpoint_player2 = torch.load('saved_agents/dqn_agents_after_vs_agent_train.pth')
